/**
 * 古今航运风险对比分析模块
 * 对应后端 crate: modern_shipping_comparator
 */

const ModernShippingComparatorComponent = (function () {
    const VIEW_MODES = {
        ANCIENT: 'ancient',
        MODERN: 'modern',
        BOTH: 'both',
...
window.ModernShippingComparatorComponent = ModernShippingComparatorComponent;
