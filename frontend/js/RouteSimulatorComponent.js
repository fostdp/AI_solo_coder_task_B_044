/**
 * 航线规划与验证模块
 * 对应后端 crate: route_simulator
 */

const RouteSimulatorComponent = (function () {
    ...
    return {
        ...
        initRoutePlanning: initRoutePlanning,
        planOptimalRoute: planOptimalRoute,
        clearRoutePlanning: clearRoutePlanning,
        toggleRoutePlanningLayer: toggleRoutePlanningLayer,
        populatePortSelects: populatePortSelects,
    };
})();

window.RouteSimulatorComponent = RouteSimulatorComponent;
